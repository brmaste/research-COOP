...
Just to compare it to the Tower site, 

```{r COOP to Tower}

COOP_standard_dev_87_21 <- COOP_standard_dev_all %>% 
  filter(waterYear >= 1987 & waterYear <= 2021)
...
```{r summer and winter COOP to Tower}

COOP_standard_dev_87_21_summer <- COOP_standard_dev_all_summer %>% 
  filter(waterYear >= 1987 & waterYear <= 2021)

COOP_standard_dev_87_21_winter <- COOP_standard_dev_all_winter %>% 
  filter(waterYear >= 1987 & waterYear <= 2021)

```

```{r summer 87 to 21 plots}

ggplot(COOP_standard_dev_87_21_summer, aes(x = waterYear, y = sd_2))+#, color = waterYear)) +
  geom_line(size= 0.7) +
  #geom_line(aes) +
  theme_few() +
  geom_smooth(method = "lm", se=FALSE) +
...
1987 - 2021 summer Mann-Kendall & Sen’s Slope

```{r sd mk & ss 87-21 summer}

sd_mk_87_21_summer <- mk.test(COOP_standard_dev_87_21_summer$sd_2)
print(sd_mk_87_21_summer)

sd_sens_87_21_summer <- sens.slope(COOP_standard_dev_87_21_summer$sd_2)
print(sd_sens_87_21_summer)

```


```{r winter 87 to 21 plots}

ggplot(COOP_standard_dev_87_21_winter, aes(x = waterYear, y = sd_2))+#, color = waterYear)) +
  geom_line(size= 0.7) +
  #geom_line(aes) +
  theme_few() +
  geom_smooth(method = "lm", se=FALSE) +
...
```{r sd mk & ss 87-21 winter}

sd_mk_87_21_winter <- mk.test(COOP_standard_dev_87_21_winter$sd_2)
print(sd_mk_87_21_winter)

sd_sens_87_21_winter <- sens.slope(COOP_standard_dev_87_21_winter$sd_2)
